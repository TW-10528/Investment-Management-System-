...
export interface HamiltonExcelFields {
  ...
  actual_payment_amount:                      number
  actual_distribution_amount:                 number
  // filled in by calculateExcelFields → extractHamiltonReport
