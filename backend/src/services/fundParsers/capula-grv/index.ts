...
export function parseCapulaGrv(
  rawText: string,
  previousState: CapulaPreviousState | null = null,
): ParsedFundNotice {
  const report = extractCapulaGrvReport(rawText, '', previousState)
