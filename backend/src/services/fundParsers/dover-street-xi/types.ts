// Dover Street XI Feeder Fund L.P. — type definitions.
...
export interface DoverReport {
  ...
  calculation_result: DoverCalculationResult & { final_excel_fields_for_frontend: DoverExcelFields }
