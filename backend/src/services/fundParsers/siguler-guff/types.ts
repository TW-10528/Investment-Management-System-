// Siguler Guff Small Buyout Opportunities Fund VI (F), LP — type definitions.
...
export interface SigulerReport {
  ...
  calculation_result: SigulerCalculationResult & { final_excel_fields_for_frontend: SigulerExcelFields }
