...
import type {
  SigulerAllFields,
  SigulerBreakdown,
  SigulerBreakdownItem,
  SigulerCalculatedFields,
  SigulerCalculationResult,
  SigulerExcelFields,
  SigulerPreviousState,
  SigulerReport,
  SigulerValidation,
} from './types'
...
function extractAllFields(text: string): SigulerAllFields {
  ...
  let inferredCommitmentAmount: number | null = null
  ...
  let inferredCumulativeAfterCall: number | null = null
  ...
  let inferredRemainingAfterCall: number | null = null
...
function buildBreakdown(a: SigulerAllFields): SigulerBreakdown {
  const capital_call_breakdown: SigulerBreakdownItem[] = []
...
function mapToExcelFields(a: SigulerAllFields, breakdown: SigulerBreakdown): SigulerExcelFields {
  ...
  if (a.report_type) remarks += ` Report type: ${a.report_type}.`
  if (a.capital_call_percent != null) remarks += ` Call percentage: ${a.capital_call_percent}%.`
...
function calculateExcelFields(
  ...
  let cumulativeContributions: number | null = inferredE
  let remainingCommitment: number | null = inferredF
  ...
  const calculatedFields: SigulerCalculatedFields = {
...
function buildValidation(
  ...
  calculationResult: SigulerCalculationResult,
): SigulerValidation {
  const requiredFields: (keyof SigulerExcelFields)[] = [
...
export function extractSigulerGuffReport(
  rawText: string,
  fileName = '',
  previousState: SigulerPreviousState | null = null,
): SigulerReport {
  ...
  const finalExcelFields: SigulerExcelFields = { ...excelFields }
