...
exports.calculateExcelFields = calculateExcelFields;
exports.extractSDGReport = extractSDGReport;
// ============================================================
// 1. Text utilities
// ============================================================
...
// 2. Field extraction
// ============================================================
function findAmountAfterLabel(text, labelPatterns, windowSize = 260) {
...
function findDateAfterLabel(text, labelPatterns, windowSize = 120) {
    for (const label of labelPatterns) {
...
function extractDistributionDate(text, fileName = '') {
...
function extractAllFields(text, fileName = '') {
    ...
    let transactionDate;
    let capitalContributionAmount;
    let distributionAmountReceived;
    let reinvestableAmount;
    let remarks;
...
function calculateCurrentTransactionCashFlow(capitalContributionAmount, distributionAmountReceived) {
    return Math.round((-amountOrZero(capitalContributionAmount) + amountOrZero(distributionAmountReceived)) * 100) / 100;
}
function calculateExcelFields(extractedFields, previousState = null) {
    ...
    let commitmentAmount = null;
    let cumulativeCapitalContributions = null;
...
function extractSDGReport(text, fileName = '', previousState = null) {
    text = normalizeText(text || '');
