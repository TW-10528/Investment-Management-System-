...
exports.extractHamiltonStrategicReport = void 0;
exports.parseHamiltonStrategic = parseHamiltonStrategic;
const extractor_1 = require("./extractor");
Object.defineProperty(exports, "extractHamiltonStrategicReport", { enumerable: true, get: function () { return extractor_1.extractHamiltonStrategicReport; } });
function parseHamiltonStrategic(rawText, previousState = null) {
    const report = (0, extractor_1.extractHamiltonStrategicReport)(rawText, '', previousState);
    ...
    // ── Confidence scoring ────────────────────────────────────────────────────────
    let score = 0;
    if (report.document_type !== 'hamilton_strategic_transaction_notice')
        score += 2;
