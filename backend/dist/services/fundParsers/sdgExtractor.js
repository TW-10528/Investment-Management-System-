...
exports.extractSdgNoticeWithPreviousState = extractSdgNoticeWithPreviousState;
const sdgExtractor_1 = require("../ocr/sdgExtractor");
/**
 * Convert SDG extraction result to ParsedFundNotice interface
 */
function extractSdgNotice(text, fileName = '') {
    const result = (0, sdgExtractor_1.extractSDGReport)(text, fileName, null);
 ...
 */
function extractSdgNoticeWithPreviousState(text, fileName = '', previousState = null) {
    return (0, sdgExtractor_1.extractSDGReport)(text, fileName, previousState);
}
