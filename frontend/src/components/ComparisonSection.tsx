...
import { exportComparisonToExcel } from '../lib/export';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-4 justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button onClick={() => {
            const comparisonData = comparisonFunds.map((f: any) => ({
            ...
            exportComparisonToExcel(comparisonData, `fund-comparison-${new Date().toISOString().split('T')[0]}.xlsx`);
            toast.success('Comparison exported to Excel');
          }}
            className="px-3 py-1.5 rounded-lg border theme-border text-sm font-medium theme-text-muted hover:theme-text transition-colors">
            ⬇️ Export
          </button>
          <button
