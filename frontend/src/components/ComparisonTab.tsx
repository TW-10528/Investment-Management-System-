  ...
  return (
    <div className="p-5 space-y-6">
      ...
      <div className="theme-card border theme-border rounded-xl p-4">
        <p className="text-sm font-semibold theme-text mb-3">Total Commitment</p>
      ...
      <div className="theme-card border theme-border rounded-xl p-4">
        <p className="text-sm font-semibold theme-text mb-3">Total Distributions</p>
        <div style={{ width: '100%', height: 250 }}>
          <ResponsiveContainer>
      ...
      <div className="theme-card border theme-border rounded-xl p-4">
        <p className="text-sm font-semibold theme-text mb-3">Dry Powder (Unfunded Commitment)</p>
        <div style={{ width: '100%', height: 250 }}>
          <ResponsiveContainer>
