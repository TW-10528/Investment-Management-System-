...
export default function FloatingCalculator() {
  ...
  return (
    ...
    >
      ...
      {/* Display */}
      <div
        className="px-4 py-4 text-right space-y-2"
        style={{ background: 'rgba(30,64,175,0.05)' }}
      >
        {/* Show expression with previous value and operation */}
        {operation && prevValue !== null && (
          <div className="text-sm font-mono theme-text-muted">
            {prevValue} {operation}
          </div>
        )}
        {/* Current value */}
        <div className="text-3xl font-mono font-bold theme-text break-words">
          {display}
        </div>
      </div>
